...
struct MapsView: View {
    ...
    let annotationItems = [
        ...
        MyAnnotationItem(
            ...
            Store_Image1: "A2_1_Image",
            Store_Detail: "A2_1_Image",
                    ...
                    Map(coordinateRegion: $region,
                        ...
                        MapAnnotation(coordinate: item.coordinate) {
                            Button(action:{
                                ...
                                StoreImage_Pub2 = item.Store_Image1!
...
struct SheetContents: View {
    ...
    var body: some View {
        if (colorScheme == .dark){
            VStack {
                popUP_Detail(StoreName_Internal: StoreName_Pub, StoreImage_Internal: StoreImage_Pub, StoreImage_Internal2: StoreImage_Pub2,Detail: StoreDetail_Pub)
